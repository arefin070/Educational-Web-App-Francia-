        ...
        <div class="form-wrapper">
            ...
            <div class="row">
                ...
                <div class="col-md-8 order-md-1">
                    <div class="col-md-8 order-md-1">
                        <h4 class="mb-3 display-4">User Privecy</h4>
                        <div class="container">
                                ...
                                <div class="container">
                                    <div class="d-md-flex justify-content-between align-items-center">
                                        <div class="form-group">
                                            <h5 class="mb-1">To processed, Please click ok!</h5>
                                            <div class="form-text mt-0"></div>
                                        </div>
                                        <div id="signup_footer" class="d-flex align-items-start">
                                            ...
                                            <a class="btn btn-primary btn-md" type="submit" value="Ok" name="subscibe" id="mc-embedded-subscribe" href="myprofil.php">Ok</a>
                                        </div>
                                    </div>
                                </div>
                            </section>
