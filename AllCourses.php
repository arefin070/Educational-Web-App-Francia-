...
<main role="main">
    ...
    <div class="jumbotron" >
        <div class="container" >
            <h3 class="display-3">All Courses</h3>
            <p>Learn how to confidently develop custom & profitable Responsive WordPress Themes and Websites with no prior experience.</p>
        </div>

    </div>
<!-- All Courses Sort by Categories -->
    <div class="container" style="padding-top: 4%">
        <h4 class="display-5">Logistic Support</h4>
            ...
            <div class="col-md-3">
                <div class="card mb-4 box-shadow">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="btn-group">
                                <a class="btn btn-sm btn-outline-secondary" href="CourseSelectedUA.php">View</a>
                                <button type="button" class="btn btn-sm btn-outline-secondary">Edit</button>
                            </div>
                            <small class="text-muted">9 mins</small>
                        </div>
        ...
        <div class="container" style="padding-top: 4%">
        <h4 class="display-5">Law and Local guide Course</h4>
        ...
        <div class="row">
            ...
            <!-- All Courses Sort by Categories -->
            <div class="container" style="padding-top: 4%">
                <h4 class="display-5">Basic Language Courses</h4>
